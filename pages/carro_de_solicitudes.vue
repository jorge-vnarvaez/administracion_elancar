<template>
  <div class="tw-py-12 lg:tw-p-24 tw-px-8 lg:tw-px-48">
    ...
    <div class="tw-flex tw-flex-col tw-bg-white tw-p-8 tw-mt-8">
      ...
      <div class="tw-grid tw-grid-cols-12" v-if="proveedorActual && receptorActual">
        <!-- DATOS PROVEEDOR -->
        <DatosProveedor
        ...
        <div v-if="empresa" class="tw-col-span-12 tw-grid tw-grid-cols-12">
          ...
          <div class="tw-col-span-6">
            <span class="tw-block tw-font-bold">Dirección de facturación</span>
            <span class="tw-block"
    ...
    >
      ...
      <div class="tw-flex tw-flex-col tw-space-x-4 align-center">
        <span class="tw-text-neutral-900 tw-font-bold tw-block tw-my-4"
          >El documento se ha emitido exitosamente, serás redirigido al menu de solicitudes
          en {{ contador }} segundos...</span
        >
