  ...
  <div>
    ...
    >
      ...
      <div  :class="
          ...
          ' tw-col-span-6 lg:tw-col-span-2 tw-py-4'
        ">
        <v-icon v-if="orden_de_compra.validada" color="green darken-1">mdi-check-bold</v-icon>
        <v-icon v-if="!orden_de_compra.validada" color="red darken-1">mdi-close-thick</v-icon>
      </div>
      <!-- VALIDADA -->
